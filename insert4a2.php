...
$Anast=date("Y-d-M",$f);
$Anacmp=date("Y-d-M",$g);
$sql= "INSERT INTO 4aform (Name,Address,Report_Number,Report_Date,Lab_ID,Sample_Desc,Sample_Drawn,Customer_Ref,Sample_ID,Test_Method,Sample_Received,Analysis_Started,Analysis_Completed) VALUES ('$Name','$Addr','$Repno','$Repd','$Labid','$Sampledesc','$Sampledr','$Custref','$Sampleid','$Testmtd','$Samprec','$Anast','$Anacmp')";
