...
<form id="hbz-searchbox" action="searchhit.php" method="POST">
    <input type="text" id="hbz-input" name="rno" placeholder=" By Report Number" />
...
<form id="hbz-searchbox" action="searchhit.php" method="POST">
    <input type="text" id="hbz-input" name="id" placeholder="By ID" />
    <input type="hidden" name="max-results" value="8" />
    <input class="hbz-submit" type="submit" name="search" value="Search">
</form>
...
<form id="hbz-searchbox" action="searchhit.php" method="POST">
    <input type="text" id="hbz-input" name="village" placeholder="By Village" />
    <input type="hidden" name="max-results" value="8" />
    <input class="hbz-submit" type="submit" name="search" value="Search">
</form>
...
<form id="hbz-searchbox" action="searchhit.php" method="POST">
    <input type="text" id="hbz-input" name="date" placeholder="By Date" />
    <input type="hidden" name="max-results" value="8" />
    <input class="hbz-submit" type="submit" name="search" value="Search">
</form>
